class SecurityHeaders {
  ...
  setupCSP() {
    if (!document.querySelector("meta[http-equiv=\"Content-Security-Policy\"]")) {
      ...
      const cspDirectives = [
        "default-src \'self\';",
        "script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' https://assets.mailerlite.com https://tally.so https://www.googletagmanager.com https://www.google-analytics.com https://cdn.plyr.io https://groot.mailerlite.com https://assets.mlcdn.com;",
