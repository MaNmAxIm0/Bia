export const translations = {
  pt: {
    ...
    close: 'Fechar',
    all_rights_reserved: '<span class="copyright-line">&copy; 2025 Beatriz Rodrigues.</span> <span class="copyright-line">Todos os direitos reservados.</span>',
    ...
    vertical_videos_desc: 'Vídeos dinâmicos otimizados para visualização vertical.',
    ...
    presentations_desc: 'Ideias e projetos comunicados de forma clara e impactante.',
    discover_more: 'Descobrir Mais',
    about_me_preview_desc: 'Conheça a minha história, paixões e competências.',
    contact_preview_desc: 'Vamos conversar! Envie uma mensagem ou encontre-me nas redes sociais.',
  ...
  en: {
    ...
    close: 'Close',
    all_rights_reserved: '<span class="copyright-line">&copy; 2025 Beatriz Rodrigues.</span> <span class="copyright-line">All rights reserved.</span>',
    ...
    presentations_desc: 'Ideas and projects communicated in a clear and impactful way.',
    discover_more: 'Discover More',
    about_me_preview_desc: 'Learn about my story, passions, and skills.',
    contact_preview_desc: 'Let\'s talk! Send a message or find me on social media.',
  ...
  es: {
    ...
    close: 'Cerrar',
    all_rights_reserved: '<span class="copyright-line">&copy; 2025 Beatriz Rodrigues.</span> <span class="copyright-line">Todos los derechos reservados.</span>',
    ...
    vertical_videos_desc: 'Vídeos dinámicos optimizados para visualización vertical.',
    ...
    presentations_desc: 'Ideas y proyectos comunicados de forma clara e impactante.',
    discover_more: 'Descubrir Más',
    about_me_preview_desc: 'Conoce mi historia, pasiones y competencias.',
    contact_preview_desc: '¡Hablemos! Envía un mensaje o encuéntrame en las redes sociales.',
