...
def main():
  ...
  for special_name in ["Logo.png", "Banner.png", "Foto de perfil.png"]:
    ...
    if drive_path:
      ...
      special_name_url = special_name.replace(" ", "%20")
      entry = {"titles": {"pt": title_pt, "en": title_en, "es": title_es}, "orientation": get_media_orientation(dest), "url": f"https://manmaxim0.github.io/Bia/imagens/{special_name_url}"}
